    ...
    public static class Database
    {
        public static Item[] items = new Item[]
        {
          new Item("images\\Cryptography_Buchanan.jpg", ItemType.Book, "Cryptography" , new List<string>{ "Buchanan, William" }, "2017", "River Publishers", "Cryptography", new HashSet<string>{"#crypto", "#cryptography", "#cryptanalysis", "#cryptology"}, true, "A100", false),
            ...
            new Item("images\\AI_Cambridge_Handbook.jpg", ItemType.Book, "The Cambridge handbook of artificial intelligence ", new List<string>{"Frankish, Keith", "Ramsey, William M."}, "2014", "Cambridge University Press", "Artificial Intelligence, Facial Recogition", new HashSet<string>{"#ml", "#machinelearning", "face", "recognition", "emotion", "ai"}, true, "C105", false)
        };
    }
